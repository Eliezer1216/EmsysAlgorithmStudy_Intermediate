/*
-> dp..
++ dp를 사용한 이유는 전에 사용했던 값을 다시 사용해야 하기 때문인데
   결국 우리의 목표는 가장 큰 마지막 값을 얻는 것인데 이 합은 각 y좌표마다의 값을 한 번씩 더한 것이다.
   따라서 이 y값을 더한 값을 가지치기 하면서 더한 값을 각 좌표의 배열에 다시 저장하는 방식으로 풀었음
